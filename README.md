...
![ArchFlow Studio 连接 CAD、SketchUp、Codex 与 D5 的自动化工作流](docs/assets/archflow-workflow-preview.png)

ArchFlow Studio 以 Codex 作为统一编排入口，连接 CAD、SketchUp 与可视化软件，让设计信息能够在二维图纸、三维模型和表现流程之间持续传递。实际支持范围取决于软件版本、Bridge 配置和人工授权。
