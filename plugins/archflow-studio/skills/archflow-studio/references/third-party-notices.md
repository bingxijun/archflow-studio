...
Run `scripts/validate_skill_package.py` before distribution. It rejects legacy RBZ layouts and accepts only the reproducibly built `archflow_bridge.rbz` whose SHA-256 is locked in `assets/integration-lock.json`.
